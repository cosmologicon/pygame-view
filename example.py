...
while playing:
	...
	pview.screen.fill((0, 0, 0))
	# Draw the slopes
	dx = 300 * slope
	ps = (0, 0), (600, 0), (600, 100 + dx), (0, 100 - dx)
	pygame.draw.polygon(pview.screen, (0, 75, 0), T(ps))
	ps = (0, 400), (600, 400), (600, 300 + dx), (0, 300 - dx)
	pygame.draw.polygon(pview.screen, (0, 75, 0), T(ps))
	# Draw the Blard
	rect = pygame.Rect((0, 0, 20, 20 + 0.02 * vy))
	rect.center = x, y
	pygame.draw.ellipse(pview.screen, (255, 255, 200), T(rect))
	write("Floppy Blard", T(50), centerx = pview.centerx, top = T(10))
	lines = [
		"Actual resolution: %dx%d" % pview.size,
